...
workload = {
    ...
    1: {  # conv2_dw
        ...
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('C', 32), 'D2': ('OX', 8), 'D3': ('OY', 4),},
    ...
    11: {  # conv7_dw, stride 2
        ...
        'operand_source_dimension_mapping': {'I': {'IX': 'OX', 'IY': 'OY', 'C': 'K'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('C', 32), 'D2': ('OX', 6), 'D3': ('OY', 4),},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    }
    ,
    12: {  # conv7_pw
        ...
        'operand_source_dimension_mapping': {'I': {'IX': 'OX', 'IY': 'OY', 'C': 'C'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 32), 'D2': ('OX', 6), 'D3': ('OY', 4)},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    },
    13: {  # conv8_dw
        'equation': 'O[b][c][oy][ox]+=W[c][fy][fx]*I[b][c][ix][iy]',
    ...
    23: {  # conv13_dw, stride 2
        ...
        'operand_source_dimension_mapping': {'I': {'IX': 'OX', 'IY': 'OY', 'C': 'K'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('C', 32), 'D2': ('OX', 3), 'D3': ('OY', 2),},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    }
    ,
    24: {  # conv13_pw
        ...
        'operand_source_dimension_mapping': {'I': {'IX': 'OX', 'IY': 'OY', 'C': 'C'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 32), 'D2': ('OX', 3), 'D3': ('OY', 2)},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    },
    25: {  # conv14_dw
        'equation': 'O[b][c][oy][ox]+=W[c][fy][fx]*I[b][c][ix][iy]',
    ...
    28: {  # fc
        ...
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 32), 'D2': ('OX', 1), 'D3': ('OY', 1)},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    }
}

...
workload = {
    0: {  # conv1, stride 2
        ...
        'constant_operands': ['W'],
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 8), 'D2': ('C', 1), 'D3': ('OX', 4), 'D4': ('OY', 4),},
    ...
    1: {  # conv2_dw
        ...
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('C', 8), 'D3': ('OX', 4), 'D4': ('OY', 4),},
    ...
    23: {  # conv13_dw, stride 2
        ...
        'operand_source_dimension_mapping': {'I': {'IX': 'OX', 'IY': 'OY', 'C': 'K'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('C', 8), 'D3': ('OX', 3), 'D4': ('OY', 2),},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    }
    ,
    24: {  # conv13_pw
    ...
    28: {  # fc
        ...
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 8), 'D2': ('C', 8), 'D3': ('OX', 1), 'D4': ('OY', 1),},
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
    }
}
